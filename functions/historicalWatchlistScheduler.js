...
import { updateHistoricalWatchlistFetchState, saveHistoricalWatchlistFetchError, createHistoricalWatchlistNotification } from './historicalWatchlistFirestoreClient.js'
...
// frontend/backend split (functions/growwHistoricalData.js).
const LOOKBACK_DAYS = {
  '1minute': 2,
  '2minute': 2,
  '3minute': 2,
...
const INTRADAY_INTERVALS = new Set(['1minute', '2minute', '3minute', '5minute', '10minute', '15minute', '30minute', '1hour', '4hour'])
